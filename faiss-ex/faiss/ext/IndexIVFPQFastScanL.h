...
#ifndef HAKES_INDEX_IVFPQFASTSCAN_L_H
#define HAKES_INDEX_IVFPQFASTSCAN_L_H
...
struct IndexIVFPQFastScanL : IndexIVFFastScanL {
  ...
  bool has_q_pq = false;
  ProductQuantizer q_pq;  ///< produces the codes during query
...
#endif  // HAKES_INDEX_IVFPQFASTSCAN_L_H
